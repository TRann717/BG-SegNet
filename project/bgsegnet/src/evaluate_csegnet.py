...
class CSegNetEvaluator:
    ...
    def _compute_final_metrics(self) -> Dict:
        ...
        metrics = {
            ...
            "fwiou": scores['fwiou'],  
            "binary_iou": scores['iou_per_class'][1],  
            "foreground_iou": scores['iou_per_class'][1],  
            "background_iou": scores['iou_per_class'][0], 
            "iou_per_class": scores['iou_per_class'].tolist(),  
            
            
            "mbiou": boundary_scores['mbiou'],  
            "biou_per_class": boundary_scores['biou_per_class'],  
            "mhd": boundary_scores['mhd'], 
            "hausdorff_per_class": boundary_scores['hausdorff_per_class'], 
            "band_iou": band_iou, 
            "hd95": boundary_scores.get('hd95', boundary_scores['mhd']),  
...
def main():
    ...
    # Param  & FPS & Dice & mIoU & Precision & Recall & band_IoU
