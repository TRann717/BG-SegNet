...
def main():
    ...
    parser.add_argument(
        ...
        help="SAM 2 models configuration file",
    )
    parser.add_argument(
        "--sam2_checkpoint",
        type=str,
        default="./checkpoints/sam2.1_hiera_base_plus.pt",
        help="path to the SAM 2 models checkpoint",
    )
    parser.add_argument(
        "--base_video_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        "(default without this flag: just the first PNG file as input to the SAM 2 models; "
    ...
    parser.add_argument(
        ...
        "(we don't apply such post-processing in the SAM 2 models evaluation)",
    )
    parser.add_argument(
    ...
    hydra_overrides_extra = [
        "++models.non_overlap_masks=" + ("false" if args.per_obj_png_file else "true")
    ]
    ...
    if args.use_all_masks:
        print("using all available masks in input_mask_dir as input to the SAM 2 models")
    else:
        print(
            "using only the first frame's mask in input_mask_dir as input to the SAM 2 models"
        )
